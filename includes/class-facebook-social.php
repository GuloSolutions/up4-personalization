...
class Facebook_Social
{
    ...
    private function load_dependencies()
    {
         ...
         * core plugin.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-facebook-social-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-facebook-social-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-facebook-social-admin.php';
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action('wp_register_scripts', $plugin_public, 'register_helper_scripts', 5);

        $this->loader->add_action('wp_register_style', $plugin_public, 'register_styles', 10);
